...
func (m *defaultUserAuthModel) Insert(ctx context.Context, data *UserAuth) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.DeleteTime, data.DelState, data.UserId, data.AuthKey, data.AuthType)
	}, cloudmindUsercenterUserAuthAuthTypeAuthKeyKey, cloudmindUsercenterUserAuthIdKey, cloudmindUsercenterUserAuthUserIdAuthTypeKey)
	return ret, err
}
...
func (m *defaultUserAuthModel) Update(ctx context.Context, newData *UserAuth) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.DeleteTime, newData.DelState, newData.UserId, newData.AuthKey, newData.AuthType, newData.Id)
	}, cloudmindUsercenterUserAuthAuthTypeAuthKeyKey, cloudmindUsercenterUserAuthIdKey, cloudmindUsercenterUserAuthUserIdAuthTypeKey)
	return err
}
